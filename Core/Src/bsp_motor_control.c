...
// 函数来生成指定范围内的随机数
int generate_random_all_position() {
    return rand() % 25; // 返回0到24之间的随机数
}

int generate_random_left_position() {
    return rand() % 15; // 返回0到24之间的随机数
}

int generate_random_right_position() {
    return rand() % 15; // 返回0到24之间的随机数
}
